    ...
    <div className="card" style={{ border: '1px solid var(--border)', borderRadius: '8px', boxShadow: 'none' }}>
      <div className="card-body" style={{ padding: '16px' }}>
        <div className="mb-3 flex items-center justify-between">
          ...
          <span
            className={`inline-flex items-center px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider ${severity.badgeClass}`}
        ...
        <p className="mb-4 text-xs font-semibold text-zinc-800 leading-relaxed">{finding.description}</p>
          ...
          <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
            {finding.expected && (
              <div className="bg-emerald-50/30 border border-emerald-100/80 p-2.5" style={{ borderRadius: '6px' }}>
                ...
                <span className="text-xs font-semibold text-emerald-950 block mt-1">{finding.expected}</span>
              </div>
            )}
            {finding.found && (
              <div className="bg-rose-50/30 border border-rose-100/80 p-2.5" style={{ borderRadius: '6px' }}>
                ...
                <span className="text-xs font-semibold text-rose-950 block mt-1">{finding.found}</span>
              </div>
            )}
          </div>
        )}
        ...
        <div className="border-t border-zinc-100 pt-2 flex items-center justify-between">
          <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-400">Regulatory Reference</span>
          <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-700 bg-zinc-100 border border-zinc-200 px-2 py-0.5" style={{ borderRadius: '4px' }}>
